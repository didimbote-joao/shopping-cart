<?php
  ...
  if (isset($_SESSION['UserID'])) {
    echo('<a class="nav-link" href="logout.php"><i class="fas fa-th-list mr-2"></i>Sair</a>');
...
<body>
  ...
  <!-- Apresenta as frutas na tela inicial -->
  <div class="container">
    <div id="message"></div>
  ...
  <!-- Apresenta as frutas na tela final -->
  ...
  $(document).ready(function() {
    ...
    // Enviando os detalhes da fruta no carrinho
    ...
    // Carregando o numero de frutas e apresenta no navbar
    load_cart_item_number();
